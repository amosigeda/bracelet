...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
				...
				<div class="row widget-row bg_color" style="padding-top: 20px">
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
							<h4 class="widget-thumb-heading">今日活跃</h4>
							<div class="widget-thumb-wrap">
								<div class="widget-thumb-body">
									<span class="widget-thumb-body-stat"  id="todayActive">0</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
							<h4 class="widget-thumb-heading">昨日活跃</h4>
							<div class="widget-thumb-wrap">
								<div class="widget-thumb-body">
									<span class="widget-thumb-body-stat" id="yesTodayActive">0</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
							<h4 class="widget-thumb-heading">近七天活跃</h4>
							<div class="widget-thumb-wrap">
								<div class="widget-thumb-body">
									<span class="widget-thumb-body-stat" id="weekBegainActive">0</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
							<h4 class="widget-thumb-heading">累计活跃</h4>
							<div class="widget-thumb-wrap">
								<div class="widget-thumb-body">
									<span class="widget-thumb-body-stat" id="allActiveData">0</span>
								</div>
							</div>
						</div>
					</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="form-body">
												<div class="form-group" >
													<label>国家</label>
													<select class="form-control input-small" id="country_select" data-live-search="true">
														<option value="">--请选择--</option>	
								...
								<div class="tabbable-bordered" id="_tab">
									<ul class="nav nav-tabs">
										...
										<li class="" id="country_tab">
											<a href="#tab_active" data-toggle="tab" aria-expanded="false"> 国家</a>
										</li>
									</ul>
													...
													<div class="portlet light portlet-fit bordered">
														<div class="portlet-title">
															<div class="caption">
																...
																<span class="caption-subject font-green bold uppercase">设备活跃机型趋势图</span>
															</div>
														</div>
														<div class="portlet-body">
															...
															<div id="_device_active_line" style="height:500px;padding-top: 10px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);"></div>
														</div>
													</div>
												</div>
											</div>
													...
													<div class="portlet light portlet-fit bordered">
														<div class="portlet-title">
															<div class="caption">
																...
																<span class="caption-subject font-green bold uppercase">设备活跃机型TOP5</span>
															</div>
														</div>
														<div class="portlet-body">
															<table id="add_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
																<thead width="100%">
																	<tr>
																		<th>机型</th>
																		<th id="device_active_day">近七天活跃</th>
																		<th>累计活跃</th>
																	</tr>
																</thead>
																<tbody id="device_active_table_tbody">
												...
												<div class="col-md-12">
													<div class="portlet light portlet-fit bordered">
														<div class="portlet-title">
															<div class="caption">
																<i class=" icon-bar-chart font-green"></i>
																<span class="caption-subject font-green bold uppercase">设备活跃国家趋势图</span>
															</div>
														</div>
														<div class="portlet-body">
															...
															<div id="_country_active_line" style="height:500px;padding-top: 10px;"></div>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col-md-12">
													<div class="portlet light portlet-fit bordered">
														<div class="portlet-title">
															<div class="caption">
																<i class=" icon-layers font-green"></i>
																<span class="caption-subject font-green bold uppercase">设备活跃国家TOP5</span>
															</div>
														</div>
														<div class="portlet-body">
															<table id="add_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
																<thead width="100%">
																	<tr>
																		<th>国家</th>
																		<th id="country_active_day" ></th>
																		<th>累计活跃</th>
																	</tr>
																</thead>
																<tbody id="country_active_table_tbody">
	...
	<script type="text/javascript">
		...
		var _device_active_line;
		var _country_active_line;
		var device_option ;
		var country_option;
		...
		$(document).ready(function(){
			...
			var date =7;
			var type = "device";
			_device_active_line = echarts.init(document.getElementById("_device_active_line"));
			_country_active_line = echarts.init(document.getElementById("_country_active_line"));
			
			if(userStatus == 'admin' && userStatus != null){
				requestActiveData(date,"country",_country_active_line,country_option);
				requestActiveData(date,type,_device_active_line,device_option);
				requestDeviceActiveTable(date,"device");
				requestCountryActiveTable(date,"country");
				requestDepartment();
				requestDevice();
				requestCountry(userStatus);
				requestBaseNum(userType,userStatus);
				$("#btn_device_seven").click(function(){  
					requestActiveData($(this).val(),"device",_device_active_line,device_option); 
				...
				$("#btn_country_seven").click(function(){
					requestActiveData($(this).val(),"country",_country_active_line,country_option);
					requestCountryActiveTable($(this).val(),"country");
				});
				...
				$("#sure_btn").click(function(){
						if(dev_select){
							requestCountryCondition($('#department_select').val(),$('#device_select').val(),$('#time_select').val(),_country_active_line,country_option);
							requestCountryTableCondition($('#department_select').val(),$('#device_select').val(),$('#time_select').val());
						}else{
							requestDeviceCondition($('#department_select').val(),$('#country_select').val(),$('#time_select').val(),_device_active_line,device_option);
							requestDeviceTableCondition($('#department_select').val(),$('#country_select').val(),$('#time_select').val());
						}
				});
			}else{
				requestBaseNum(userType,userStatus);
				requestDeviceCondition(userStatus,"",7,_device_active_line,device_option);
				requestDeviceTableCondition(userStatus,"",7);
				requestCountryCondition(userStatus,"",7,_country_active_line,country_option);
				...
				$("#btn_device_thirty").click(function(){  
					requestDeviceCondition(userStatus,"",30,_device_active_line,device_option);
				...
				$("#btn_country_thirty").click(function(){
					...
					requestCountryCondition(userStatus,"",30,_country_active_line,country_option);
					requestCountryTableCondition(userStatus,"",30);
					
				});
				$("#sure_btn").click(function(){
					if(dev_select){
						requestCountryCondition(userStatus,$('#device_select').val(),$('#time_select').val(),_country_active_line,country_option);
						requestCountryTableCondition(userStatus,$('#device_select').val(),$('#time_select').val());
					}else{
						requestDeviceCondition(userStatus,$('#country_select').val(),$('#time_select').val(),_device_active_line,device_option);
			...
			$("#reset_btn").click(function(){
				//requestActiveData($(this).val(),"country",_country_active_line,country_option);
				//equestCountryActiveTable($(this).val(),"country");
		...
		function requestActiveData(date,type,ec,option){
		...
		function requestDeviceActiveTable(date,type){
			...
			$.ajax({
		        ...
		        success:function(jsons){  
		            ...
		            $.each(json,function(){
		            	var tr= $("<tr>");
		            	$("#device_active_table_tbody").html($("#device_active_table_tbody").html() + "<tr><td>" +this.dev_name + " </td><td> "  +this.dayActive + "</td> <td> "  +this.sum + " </td></tr> ");
		            });
		        },  
		        error:function(){  
		           // alert("数据加载失败！请检查数据链接是否正确");  
		           $("#device_active_table_tbody").html("数据获取失败");
		        }  
			});
		}
		function requestCountryActiveTable(date,type){
			var requestUrl = "${baseURL }/device/active/getTableData/"+type+"/"+date;
			$.ajax({
				url:requestUrl,  
		        type:'get',  
		        ...
		        success:function(jsons){  
		            var json = jsons;  
		            $("#country_active_table_tbody").html("");
		            $("#country_active_day").html("近"+ date +"天活跃");
		            $.each(json,function(){
		            	var tr= $("<tr>");
		            	$("#country_active_table_tbody").html($("#country_active_table_tbody").html() + "<tr><td>" +this.country + "</td> <td> "  +this.dayActive + " </td><td> "  +this.sum + " </td></tr> ");
		            });
		        },  
		        error:function(){  
		           // alert("数据加载失败！请检查数据链接是否正确");  
		           $("#country_active_table_tbody").html("数据获取失败");
		        }  
			});
		}
		...
		function requestDeviceCondition(departName,typedata,time,ec,option){
			var requestUrl = "${baseURL }/device/active/getSearch/device/" + time;
			ec.showLoading({
				text:'数据加载中...'
			});
			$.ajax({
		...
		function requestCountryCondition(departName,typedata,time,ec,option){
			var requestUrl = "${baseURL }/device/active/getSearch/country/"+time;
			ec.showLoading({
				text:'数据加载中...'
			});
			$.ajax({
		...
		function requestDeviceTableCondition(departName,typedata,date){
			var requestUrl = "${baseURL }/device/active/getSearchTable/device/"+date;
			$.ajax({
				url:requestUrl,  
		        type:'get',  
		        data: {country:typedata,departName:departName},
		...
		function requestCountryTableCondition(departName,typedata,date){
			var requestUrl = "${baseURL }/device/active/getSearchCountryTable/country/"+date;
			$.ajax({
				url:requestUrl,  
		        type:'get',  
		        data: {devName:typedata,departName:departName},
		        ...
		        error:function(){  
		           // alert("数据加载失败！请检查数据链接是否正确");  
		           $("#country_active_table_tbody").html("无数据");
		        }  
			});
		}
		$('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
			_country_active_line.resize();
		});
		function requestBaseNum(userType,userStatus){
			var requestUrl = "${baseURL }/device/active/baseData"+"?userType="+userType+"&userStatus="+userStatus;
			$.ajax({
				url:requestUrl,
				dataType:'json',
				type:'get',
				success:function(jsons){
					...
					var todayActive = jsons.todayActive;
					var yesTodayActive = jsons.yesTodayActive;
					var weekBegainActive = jsons.weekBegainActive;
					var allData  = jsons.allData;
					console.log(todayActive+" "+yesTodayActive+" "+weekBegainActive+" "+allData);
					...
					$("#todayActive").html(todayActive);
					$("#yesTodayActive").html(yesTodayActive);
					$("#weekBegainActive").html(weekBegainActive);
					$("#allActiveData").html(allData);
